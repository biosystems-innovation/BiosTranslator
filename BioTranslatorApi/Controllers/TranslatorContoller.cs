...
namespace BioTranslatorApi.Controllers
{
    ...
    public class TranslatorController : ControllerBase
    {
        ...
        /// <summary>
        /// Translates the given list of texts
        ...
        /// <summary>
        /// Translates the given list of texts to the specified language
        /// From: autodetect
        /// </summary>
        /// <param name="toTranslate"></param>
        /// <param name="to"></param>
        ...
        /// <summary>
        /// Translates the given list of texts from the specified language to the specified language
        /// </summary>
        /// <param name="toTranslate"></param>
        /// <param name="to"></param>
